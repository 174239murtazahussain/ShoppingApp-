    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(BuyerSignUp.this , Theme_Material_Dialog_MinWidth, onDateSetListener, year, month, day );
                ...
                reff2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (found == false){
                            ...
                            editor.apply();
                            Toast.makeText(BuyerSignUp.this, "Redirecting", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(BuyerSignUp.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                        else {
                            Toast.makeText(BuyerSignUp.this, "E-mail already exists.", Toast.LENGTH_SHORT).show();
                        }
